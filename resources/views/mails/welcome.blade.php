                        ...
                        <div class="block-grid" style="Margin: 0 auto; min-width: 320px; max-width: 620px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;">
                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                                <div class="col num12" style="min-width: 320px; max-width: 620px; display: table-cell; vertical-align: top; width: 620px;">
                                    <div style="width:100% !important;">
                                        <div style="color:#71777D;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;line-height:1.5;padding-top:25px;padding-right:10px;padding-bottom:15px;padding-left:10px;">
                                            <div style="font-size: 12px; line-height: 1.5; color: #71777D; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px;">
                                                <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                    <span style="color: #000000; font-size: 16px;">
                                                        ...
                                                        <br /><br />
                                                        <p style="color: #000000; font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">All requests, including password resets, new device requests, new software requests, new user accounts, and technical concerns, must be submitted through the ticketing system.  Please  <a href="{{ $data['resetLink'] }}" >click here</a> and enter the following login credentials to submit a ticket to IT.</p>
                                                        <br /><br />
                                                    </span>
                                                    <div style="text-align: center;">
                                                        Password: {{ $data['password'] }}
                                                        <!-- <a style="text-decoration:none; padding:7px 15px; border-radius:15px; background:#3490dc;color: white;   font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;" href="{{ $data['resetLink'] }}" >My Account</a> -->
                                                         <br /><br />
                                                    </div>
                                                    <br/>
                                                    <div style="">
                                                        <p style="color: #000000; font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">  If you didn't make this request, contact us on support@yopmail.com </p>
                                                        <br /><br /><br/>
                                                    </div>
                                                    <!--
                                                    <div style="">
