                                            ...
                                            <div style="font-size: 12px; line-height: 1.5; color: #71777D; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px;">
                                                <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                    <span style="color: #000000; font-size: 16px;">
                                                        ...
                                                        <br /><br />
                                                        <p style="color: #000000; font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">  Forgot your password? <br /> Don't worry, we've got your back.</p>
                                                        <br /><br />
                                                    </span>
                                                    <div style="text-align: center;">
                                                        <a style="text-decoration:none; padding:7px 15px; border-radius:15px; background:#3490dc;color: white;   font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;" href="{{ $data['resetLink'] }}" >Reset My Password!</a>
                                                         <br /><br />
                                                    </div>
                                                    <br/>
                                                    <div style="">
